...
import ProductionPrepShell from './components/ProductionPrepShell'

export default function ProductionPrepPage() {
  const params = useParams<{ projectId?: string }>()
  if (!params?.projectId) throw new Error('ProductionPrepPage requires projectId route param')
    ...
    <div className="glass-page min-h-screen">
      ...
      <main className="mx-auto flex w-full max-w-[1500px] flex-col gap-4 px-4 py-5 lg:px-6">
        ...
        {projectQuery.isLoading ? (
          ...
          <ProductionPrepShell projectId={projectId} projectName={projectName} />
        )}
      </main>
    </div>
  )
