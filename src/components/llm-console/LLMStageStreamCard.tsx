...
import { LLMStageStreamCardHeader } from './LLMStageStreamCardHeader'
...
export default function LLMStageStreamCard({
  ...
  return (
    <article className="glass-surface-modal flex h-full w-full flex-col overflow-hidden rounded-2xl text-[var(--glass-text-primary)]">
      <LLMStageStreamCardHeader
        title={title}
        subtitle={subtitle}
        activeStageTitle={activeStage.title}
        activeMessage={activeMessage || activeStage.subtitle}
        currentStep={currentStep}
        stageCount={stageCount}
        normalizedOverallProgress={normalizedOverallProgress}
        errorMessage={errorMessage}
        topRightAction={topRightAction}
        resolveProgressText={resolveProgressText}
        t={t}
      />
